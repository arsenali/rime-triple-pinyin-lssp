...
如此，在輸入第3碼之後便得到了唯一的一個帶調音節，不會有重複音節。
  ...
  {"便捷輸入", [[
[無聲調模式]
如果不想區分聲調，可長按或上滑T鍵切換到無聲調模式，此時在第3碼可用TGB三鍵輸入無聲調音節。
打字過程中也可隨時把已輸入的帶調音節轉換為無聲調音節，右滑“全碼”鍵進行轉換，而不必切換到無聲調模式重新輸入。

[首碼簡拼、前兩碼簡拼、全碼輸入]
打字過程中，右滑“簡碼”鍵，檢索首碼簡拼。
打字過程中，點擊“簡碼”鍵，強制檢索前兩碼簡拼。
打字過程中，點擊“全碼”鍵，強制檢索全碼字。
...
[尖音輸入]
方言中有尖音的朋友可打尖音字以降低重碼率，ㄗ開頭的尖音音節以“ㄅ+第3、4區韻母”（ㄅㄨ除外）輸入，例如：尖ㄗㄧㄢˉ=ㄅㄨㄢˉ，絕ㄗㄩㄝˊ=ㄅㄩㄝˊ；同理，ㄘ開頭的尖音音節以“ㄆ+第3、4區韻母”（ㄆㄨ除外）輸入，ㄙ開頭的尖音音節以“ㄇ+第3、4區韻母”（ㄇㄨ除外）輸入。
